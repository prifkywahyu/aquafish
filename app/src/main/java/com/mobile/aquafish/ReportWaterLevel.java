...
import com.mobile.aquafish.adapter.WaterLevel;
...
public class ReportWaterLevel extends AppCompatActivity {

    private final static String typeWaterLevel = "303";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Call<SensorModel.Report> listCall = service.getSensorData(getCode, typeWaterLevel);
        listCall.enqueue(new Callback<SensorModel.Report>() {
            ...
            public void onResponse(@NotNull Call<SensorModel.Report> call, @NotNull Response<SensorModel.Report> response) {
                if(response.body() != null) {
                    ...
                    WaterLevel waterLevel = new WaterLevel(sensorModels, R.layout.report_water_level, getApplicationContext());
                    ...
                    recyclerView.setAdapter(waterLevel);
